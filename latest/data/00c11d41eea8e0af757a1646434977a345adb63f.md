...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - paragraph [ref=e6]: An error occurred during a connection to ragapp-eight.vercel.app. PR_END_OF_FILE_ERROR
    ...
    - paragraph [ref=e12]:
      - link "Learn more…" [ref=e13] [cursor=pointer]:
        - /url: https://support.mozilla.org/1/firefox/142.0.1/Linux/en-US/connection-not-secure
